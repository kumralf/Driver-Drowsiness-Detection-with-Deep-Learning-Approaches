...
for sira in range(1,384):
    ...
    VIDEO_PATHS = 'C:/Users/kumralf/Desktop/videos_tek/'+str(sira)+'.avi'
    ...
    # detection_classes should be ints.
        ...
        for r in range(0,8):
            if r in detection_names:
                matrix[frame_no][(r)*6] = 1
                matrix[frame_no][(r)*6+1] = 1
                matrix[frame_no][(r)*6+2] = 1
                # matrix[frame_no][(r)*6+3] = 1
        ...
        # sonuc = np.asmatrix(sonuc)
            ...
            if (karar[1*6]==1 and karar[2*6]==0 and karar[3*6]==0 and karar[4*6]==1 and karar[5*6]==0 and karar[6*6]==0 and karar[7*6]==0):
                ...
                Image.fromarray(matris, mode='L').save('C:/Users/kumralf/Desktop/bitirme/features50/normal_genis/normal' + str(it)+'_'+str(pathson.name) + '.jpg')
                matris=0
            ...
            #     matris = (matris * 255).astype(np.uint8)
            #     Image.fromarray(matris, mode='L').save('C:/Users/kumralf/Desktop/bitirme/features50/normal/normal' + str(it)+'_'+str(pathson.name) + '.jpg')
            #     matris=0
            ...
            # elif (karar==[1,0,0,0,1,0,0]):
                ...
                matris = (matris * 255).astype(np.uint8)
                Image.fromarray(matris, mode='L').save('C:/Users/kumralf/Desktop/bitirme/features50/drowsy_genis/drowsy' + str(it)+'_'+str(pathson.name) + '.jpg')
                matris=0
            ...
            #     matris = (matris * 255).astype(np.uint8)
            #     Image.fromarray(matris, mode='L').save('C:/Users/kumralf/Desktop/bitirme/features50/drowsy/drowsy' + str(it)+'_'+str(pathson.name) + '.jpg')
            #     matris=0
            # elif (karar==[0,1,0,1,0,0,0]):
                ...
                matris = (matris * 255).astype(np.uint8)
                Image.fromarray(matris, mode='L').save('C:/Users/kumralf/Desktop/bitirme/features50/danger_genis/danger' + str(it)+'_'+str(pathson.name) + '.jpg')
                matris=0
            # elif (karar==[0,1,0,0,0,0,0]):
            #     matris = (matris * 255).astype(np.uint8)
            #     Image.fromarray(matris, mode='L').save('C:/Users/kumralf/Desktop/bitirme/features50/danger/danger' + str(it)+'_'+str(pathson.name) + '.jpg')
            #     matris=0
            ...
            # matris = (matris * 255).astype(np.uint8)
            # Image.fromarray(matris, mode='L').save('pic' + str(it) + '.jpg')
            # matris=0
