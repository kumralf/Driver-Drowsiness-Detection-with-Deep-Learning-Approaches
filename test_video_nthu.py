...
VIDEO_PATHS = 'C:/Users/kumralf/Desktop/Testing_Dataset/003_sunglasses_mix.mp4'

frame_size =(640,480)

out = cv2.VideoWriter('C:/Users/kumralf/Desktop/mydataset/bitirme_output/sunglasses_output.mp4', -1, 20.0, frame_size)
...
while(video.isOpened()):
    ...
    if f == 0:
        ...
        if (sonuc[4*6]>5):                                         
            ...
            karar[(1*6):(1*7-1)]=[1,1,1]
            
        # elif (sonuc[5*6]>tekrar*0.1):
        #     karar[(5*6):(5*7-1)]=[1,1,1]
            
        # elif (sonuc[6*6]>tekrar*0.1):
